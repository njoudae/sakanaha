...
| -------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `saknaha.owners`           | `userService.ts`      | `Owner[]`: `id`, `fullName`, `phone`, `ministryPropertyNumber`, `createdAt`                                                                                                                 | `ownerProfiles`, linked `userProfiles` when claimed                            | Import each owner as an owner profile linked directly to an authenticated user profile when claimed. Preserve legacy ID in migration metadata.                                                                                                                | Required string fields: `id`, `fullName`, `phone`, `createdAt`; phone normalized to digits; license number retained but not trusted as verified.                                                                                                                    | Keep original localStorage untouched; disable Convex read flag and return to local owner login flow during compatibility period.                                               |
...
- Re-running a migration must never create duplicate owner profile, user, property, favorite, or notification records.
...
- When a property references a missing owner, import as quarantined or attach to a migration holding owner profile, never publish automatically.
...
sequenceDiagram
  ...
  Importer->>Convex: Upsert profiles, owner profiles, properties by idempotency key
